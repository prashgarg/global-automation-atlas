...
\centering
\footnotesize
\caption{Data inputs and constructed measures used in the paper.}
\label{tab:data_inventory}
\begin{tabular}{@{}L{0.29\textwidth}L{0.25\textwidth}C{0.11\textwidth}L{0.25\textwidth}@{}}
\toprule
Dataset or measure & Identifier & Count & Role \\
\midrule
